...
file = Path("datasets/nlu/en/web_application_corpus/raw.json")
...
json.dump(train_x, open("datasets/nlu/en/web_application_corpus/train.json", "w"), indent=4, ensure_ascii=False)
json.dump(test_x, open("datasets/nlu/en/web_application_corpus/test.json", "w"), indent=4, ensure_ascii=False)