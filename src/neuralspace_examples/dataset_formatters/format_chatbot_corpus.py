...
json.dump(train_x, open("../../../datasets/nlu/en/chatbot_corpus/train.json", "w"), indent=4, ensure_ascii=False)
json.dump(test_x, open("../../../datasets/nlu/en/chatbot_corpus/test.json", "w"), indent=4, ensure_ascii=False)